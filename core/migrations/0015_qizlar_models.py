...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("core", "0014_uzchess_seed_aliases"),
    ]

    operations = [
        migrations.CreateModel(
            name="QizlarAkademiyasiStatSnapshot",
            fields=[
        ...
        migrations.CreateModel(
            name="QizlarAkademiyasiMahallaStat",
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ...
                ("mahalla", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="qizlar_stats", to="core.mahalla")),
                ("snapshot", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="area_stats", to="core.qizlarakademiyasistatsnapshot")),
            ],
            options={
        ...
        migrations.CreateModel(
            name="QizlarAkademiyasiMahallaAlias",
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("api_name", models.CharField(max_length=255)),
                ("api_norm", models.CharField(db_index=True, max_length=255, unique=True)),
                ("last_seen", models.DateTimeField(auto_now=True)),
                ("mahalla", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="qizlar_aliases", to="core.mahalla")),
            ],
            options={
